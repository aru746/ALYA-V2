module.exports = {
  ...
  onChat: async ({ api, event }) => {
    ...
    const emojis = {
      ...
      "😆": ["ridicule","🤣","😹","😂","haha", "clownesque", "farce", "pitrerie", "comique", "drôle", "amusant", "hilarant", "loufoque", "bouffonnerie", "cocasse", "burlesque", "rigolo", "absurde", "irrévérencieux", "ironique", "parodie", "esprit", "facétieux"],
      "😎": ["cool", "formidable", "😎"],
      "⚡": ["super", "aesther"],
      "🐄": ["niru"],
      "🦡": ["jannat"],
      ...
      "💙": ["manga", "anime", "sukuna"],
      "😕": ["bruh"],
      "🫡": ["aru","arijit","arjit","kuze","naruto","owner","admin"],
      "👎": ["kindly provide"],
