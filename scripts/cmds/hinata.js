    ...
    if (event.type !== "message_reply" && mahmud.some(word => message.startsWith(word))) {
      ...
      const res = await axios.post(`${await baseApiUrl()}/api/hinata`, { text, style: 3, attachments });  return res.data.message; } catch {  return "error janu🥹";
       ...
       const randomMessage = [
          ...
          "🐒🐒🐒",
          "bye",
          "naw amr boss k message daw https://www.facebook.com/arukuze016",
          "mb ney bye",
          "meww",
          ...
          "কেমন আসো",
          "বলেন sir__😌",
          "আমাকে এতো না ডেকে আমার বস মানে Aru কে ডাক দাও তো 😒",
          ...
          "𝗕𝗯𝘆 𝗕𝗯𝘆 না করে আমার বস মানে, kuze ,kuze ও তো করতে পারো😑?",
