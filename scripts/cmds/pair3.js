...
module.exports = {
    ...
    onStart: async function ({ api, event }) {
        ...
        var djtme = Array(5).fill(`${rd1}`).concat([`${cc[Math.floor(Math.random() * cc.length)]}`], Array(4).fill(`${rd1}`));
        ...
        var bgURL = "https://i.postimg.cc/nrgPFtDG/Picsart-25-08-12-20-22-41-970.png";
